...
def _diretorio_componente_davi_swipe():
    pasta = os.path.join(tempfile.gettempdir(), "aproar_davi_swipe_v5")
    os.makedirs(pasta, exist_ok=True)
    index_path = os.path.join(pasta, "index.html")
    html = base64.b64decode("").decode("utf-8")
    try:
        atual = ""
...
_COMPONENTE_DAVI_SWIPE = st.components.v1.declare_component(
    "aproar_davi_swipe_v5", path=_diretorio_componente_davi_swipe()
)
...
if modo_davi:
    ...
    if MODO_DAVI_SIMPLES:
        ...
        evento_davi = _COMPONENTE_DAVI_SWIPE(
            ...
            key=f"aproar_davi_swipe_v5_{DATA_REF_ROTA_STR}",
            default=None,
        )
