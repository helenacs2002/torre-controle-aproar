...
# === A NOVA INTELIGÊNCIA BOMB-PROOF DE LEITURA DE DEMANDAS ===
def extrair_dados_completos(texto, card_name):
    ...
    if texto:
        ...
        # Regex blindada contra pontos, vírgulas e quebras de linha estranhas
    ...
    # --- INTELIGÊNCIA DE FALLBACK (SALVA-VIDAS) ---
    # Se ele não achar o destino na descrição, mas tiver no Título, ele puxa do Título!
    if not destino and unidade:
        destino = unidade
    # Se não escreveram de onde coletar, o sistema assume 99% dos casos: ESCRITÓRIO.
